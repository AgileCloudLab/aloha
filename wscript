...
def build(bld):
    ...
    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_threaded_encoder/test_multiple_threaded_encoders.cpp',
    #             target='test_multiple_threaded_encoders',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_threaded_encoder/test_threaded_encoder.cpp',
    #             target='test_threaded_encoder',
    #             use=['kodo_rlnc_includes'])


    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_smart_encoder/test_smart_encoder.cpp',
    #             target='test_smart_encoder',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_simple_encoder/test_simple_encoder.cpp',
    #             target='test_simple_encoder',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_complex_encoder/test_complex_encoder.cpp',
    #             target='test_complex_encoder',
    #             use=['kodo_rlnc_includes'])

    # # bld.program(features='cxx',
    # #             source='./src/parallel_encoder/test/test_smart_symbol_encoder/test_smart_symbol_encoder.cpp',
    # #             target='test_smart_symbol_encoder',
    # #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/test/test_temp_smart_symbol_encoder/test_temp_smart_symbol_encoder.cpp',
    #             target='test_temp_smart_symbol_encoder',
    #             use=['kodo_rlnc_includes'])


    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/benchmark/encoder/smart_encoder_benchmark.cpp',
    #             target='smart_encoder_benchmark',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/benchmark/encoder/simple_encoder_benchmark.cpp',
    #             target='simple_encoder_benchmark',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/benchmark/encoder/complex_encoder_benchmark.cpp',
    #             target='complex_encoder_benchmark',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/benchmark/encoder/smart_symbol_encoder_benchmark.cpp',
    #             target='smart_symbol_encoder_benchmark',
    #             use=['kodo_rlnc_includes'])

    # bld.program(features='cxx',
    #             source='./src/parallel_encoder/benchmark/single_thread_encoder/one_coefficient.cpp',
